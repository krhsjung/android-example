...
import kr.hs.jung.example.utils.webrtc.audio.AudioDevice.BluetoothHeadset
import kr.hs.jung.example.utils.webrtc.audio.AudioDevice.Earpiece
import kr.hs.jung.example.utils.webrtc.audio.AudioDevice.Speakerphone
import kr.hs.jung.example.utils.webrtc.audio.AudioDevice.WiredHeadset
import kr.hs.jung.example.utils.webrtc.audio.AudioDeviceChangeListener
import kr.hs.jung.example.utils.webrtc.audio.AudioSwitch.State.ACTIVATED
import kr.hs.jung.example.utils.webrtc.audio.AudioSwitch.State.STARTED
import kr.hs.jung.example.utils.webrtc.audio.AudioSwitch.State.STOPPED
